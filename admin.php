...
<body>
    ...
    <footer class="text-center p-5 bg-primary text-white">
        <div>
            <a href="https://www.instagram.com/_anzasyahbani?igsh=MTV2YzlvMHo1cW5jag%3D%3D&utm_source=qr"><i class="bi bi-instagram h2 p-2 text-white"></i></a>
            <a href="https://www.tiktok.com/@zaaaan50?_t=ZS-90u0RJDOIM4&_r=1"><i class="bi bi-tiktok h2 p-2 text-white"></i></a>
            <a href="https://wa.me/6282334215139"><i class="bi bi-whatsapp h2 p-2 text-white"></i></a>
        </div>
        <div>Anza Ali Syahbani &copy; 2023</div>
    </footer>
    <!-- footer end -->
    <script
